// Modified for codsh: disambiguate a one-range assertion for Rust 1.98 Clippy.
...
mod tests {
    ...
    fn wrap_ranges_trim_empty_text_does_not_panic() {
        ...
        // Modified for codsh: avoid ambiguous one-range vector syntax in Clippy.
        assert!(ranges.is_empty() || ranges.as_slice() == std::slice::from_ref(&(0..0)));
    }
