//! Modified for codsh: ASCII product identity and an offline palette replace upstream branding.
...
const LOGO: &str = "  ____ ___  ____  ____  _   _\n / ___/ _ \\|  _ \\/ ___|| | | |\n| |  | | | | | | \\___ \\| |_| |\n| |__| |_| | |_| |___) |  _  |\n \\____\\___/|____/|____/|_| |_|";
const LOGO_SMALL: &str = "codsh";
...
/// The codsh ASCII art does not require braille-capable fonts.
fn logo_hidden() -> bool {
    false
}
