...
_codsh_rust_complete() {
  ...
  local commands="help completions inspect import feedback plugin login logout setup voice web sessions dashboard export share du disk-usage memory worktree"
