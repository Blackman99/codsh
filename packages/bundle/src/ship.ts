...
This turn is to-spec (gate 1) only. On Confirm, set Status to confirmed then stop — the runner compiles the sealed Mission Contract from Main Track + acceptance + Out of Scope; do not hand-author that JSON. On Abort, stop. Do not start tickets or landing — the next /ship turn injects that contract.`
