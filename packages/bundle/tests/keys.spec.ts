...
describe('KeyDecoder', () => {
  ...
  it.each([
    ...
    { label: 'Ctrl-G toggles the panorama', bytes: '\u0007', key: { kind: 'toggle-panorama' } },
  ...
  it.each([
    ...
    { label: 'Ctrl+Enter steers the running turn', bytes: `${ESC}[13;5u`, keys: [{ kind: 'steer' }] },
    { label: 'Ctrl+Shift+Enter steers too: Control wins over Shift', bytes: `${ESC}[13;6u`, keys: [{ kind: 'steer' }] },
    { label: 'Ctrl+Q opens the queue', bytes: `${ESC}[113;5u`, keys: [{ kind: 'toggle-queue' }] },
    { label: 'Ctrl+G toggles the panorama', bytes: `${ESC}[103;5u`, keys: [{ kind: 'toggle-panorama' }] },
