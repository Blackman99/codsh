...
- `/ui compact|comfortable` sets how much room the transcript takes. Compact is the default and the shape everything above is described in; comfortable only adds — a blank row between turns, a 3-row live thinking preview (6 rows in comfortable), and a higher click-to-pager threshold on expanded diffs. The choice persists across sessions.
