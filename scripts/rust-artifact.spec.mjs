...
describe('dsh plugins in a clean global install', () => {
  it('load harness packages from the running dsh, not from the codsh-cli directory', () => {
    ...
    const plugins = ['rust-acp-plan.mjs', 'rust-acp-file-approval.mjs', 'rust-acp-hooks.mjs', 'rust-acp-subagents.mjs', 'rust-acp-background.mjs', 'rust-acp-control.mjs', 'rust-acp-mcp.mjs', 'rust-acp-goal.mjs', 'rust-acp-compact.mjs', 'rust-acp-web.mjs', 'rust-acp-plain.mjs']
